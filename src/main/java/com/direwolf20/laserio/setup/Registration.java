...
public class Registration {
    ...
    public static final Supplier<RecipeSerializer<CardClearRecipe>> CARD_CLEAR_RECIPE_SERIALIZER = RECIPE_SERIALIZERS.register("cardclear", () -> CardClearRecipe.SERIALIZER);
