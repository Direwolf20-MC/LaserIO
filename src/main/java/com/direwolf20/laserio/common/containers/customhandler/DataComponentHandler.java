...
public class DataComponentHandler implements IItemHandlerModifiable {
    ...
    private NonNullList<ItemStack> getItemList() {
        DireItemContainerContents contents = this.stack.getOrDefault(LaserIODataComponents.ITEMSTACK_HANDLER, DireItemContainerContents.fromItems(NonNullList.withSize(size, ItemStack.EMPTY)));
    ...
    private void setItemList(NonNullList<ItemStack> itemStacks) {
        this.stack.set(LaserIODataComponents.ITEMSTACK_HANDLER, DireItemContainerContents.fromItems(itemStacks));
    }
}
